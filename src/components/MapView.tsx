...
// Fix default marker icon URLs (avoid Leaflet's broken default)
const defaultIcon = new L.DivIcon({
  className: "",
  html: `<div style="width:18px;height:18px;border-radius:9999px;background:oklch(0.58 0.18 252);box-shadow:0 0 0 4px white,0 4px 12px rgba(7,112,227,0.4);"></div>`,
  iconSize: [18, 18],
  iconAnchor: [9, 9],
});
