    ...
    <div className="flex min-h-screen items-center justify-center bg-background px-4">
      <div className="max-w-md text-center">
        ...
        <div className="mt-6">
          <Link
            to="/"
            className="inline-flex items-center justify-center rounded-full bg-primary px-5 py-2.5 text-sm font-semibold text-primary-foreground shadow-card hover:opacity-90"
          >
            Ke Beranda
          </Link>
        </div>
...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { name: "description", content: "Pesan shuttle ke Bandara KNO dan ride hailing dalam satu aplikasi. Cepat, premium, terpercaya." },
      { property: "og:title", content: "PYU-GO" },
      { property: "og:description", content: "Shuttle KNO & Ride Hailing dalam satu app." },
